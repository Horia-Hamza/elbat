...
export const TermsConditions: React.FC = () => {
  ...
  useSEO({
    title: 'الشروط والأحكام | متجر البط',
    description: 'اطلع على شروط وأحكام استخدام متجر البط — حقوقك وواجباتك كعميل عند التسوق عبر موقعنا الإلكتروني.',
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '3rem auto', padding: '0 1.5rem', direction: 'rtl', textAlign: 'right', lineHeight: 1.8 }}>
      ...
      <p style={{ color: 'var(--text-muted)', marginBottom: '1.5rem' }}>
        يسرنا الترحيب بك في موقع <strong>متجر البط</strong>. باستخدامك لهذا الموقع أو الشراء منه، فإنك توافق على الالتزام الكامل بالشروط والأحكام التالية التي تحكم العلاقة بينك وبين متجرنا.
      </p>
