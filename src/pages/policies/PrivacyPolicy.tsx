  ...
  return (
    <div style={{ maxWidth: '800px', margin: '3rem auto', padding: '0 1.5rem', direction: 'rtl', textAlign: 'right', lineHeight: 1.8 }}>
      ...
      <p style={{ color: 'var(--text-muted)', marginBottom: '1.5rem' }}>
        أهلاً بك في <strong>متجر البطّ</strong>. نحن نلتزم بحماية خصوصيتك وضمان أمان بياناتك الشخصية بالكامل. توضح هذه السياسة كيفية جمع واستخدام وحماية معلوماتك الشخصية عند زيارة موقعنا أو الشراء منا.
      </p>
