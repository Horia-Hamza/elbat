  ...
  return (
    <div style={{ maxWidth: '800px', margin: '3rem auto', padding: '0 1.5rem', direction: 'rtl', textAlign: 'right', lineHeight: 1.8 }}>
      ...
      <p style={{ color: 'var(--text-muted)', marginBottom: '1.5rem', fontSize: '1.05rem' }}>
        في <strong>عائلة البطّ (Elbat)</strong>، راحتك هي أولويتنا الأولى. نحن نعلم مدى حماسك لوصول طلبيتك، ولذلك نوفر لك أسرع خدمة شحن احترافية وآمنة تغطي جميع محافظات جمهورية مصر العربية.
      </p>
